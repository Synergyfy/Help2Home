    ...
    return (
        <div className="p-4 md:p-8 max-w-7xl mx-auto">
            <Link
                ...
                className="inline-flex items-center gap-2 text-gray-500 hover:text-gray-900 font-bold mb-6 transition-colors"
            >
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
                <div>
                    <h1 className="text-2xl font-bold text-[#111811]">{data.projectTitle}</h1>
                    <p className="text-gray-500">Contract ID: #{data.id} • Managed by {data.developer}</p>
                </div>
                <button className="flex items-center gap-2 px-5 py-2.5 border border-gray-200 rounded-xl font-bold text-gray-700 hover:bg-gray-50 transition-colors">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
                <div className="p-6 bg-white rounded-2xl border border-gray-100 shadow-sm">
                    <p className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-1">Total Principal</p>
                    <p className="text-2xl font-bold text-gray-900">₦{data.investedAmount.toLocaleString()}</p>
                </div>
                <div className="p-6 bg-white rounded-2xl border border-gray-100 shadow-sm">
                    <p className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-1">Maturity Date</p>
                    <p className="text-2xl font-bold text-gray-900">{data.maturityDate}</p>
                </div>
                <div className="p-6 bg-green-50 rounded-2xl border border-green-100 shadow-sm">
                    <p className="text-xs font-bold text-green-600 uppercase tracking-widest mb-1">Total ROI</p>
                    <p className="text-2xl font-bold text-green-700">{data.roi}%</p>
                </div>
            </div>
