        ...
        <div className="p-4 md:p-8 max-w-7xl mx-auto">
            ...
            <div className="mb-6">
                <div className="flex items-center gap-2 text-sm text-gray-600">
                    <Link href="/dashboard/tenant" className="hover:text-brand-green transition-colors">Dashboard</Link>
                    <span>/</span>
                    <Link href="/dashboard/tenant/marketplace" className="hover:text-brand-green transition-colors">Marketplace</Link>
                    <span>/</span>
