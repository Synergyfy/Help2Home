...
export default function LandlordEducationHubPage() {
    ...
    return (
        <div className="p-4 md:p-8 max-w-7xl mx-auto font-sans">
            ...
            <div className="mb-8">
                ...
                <p className="text-gray-600">Resources and guides to help you manage your properties and tenants effectively.</p>
            </div>
