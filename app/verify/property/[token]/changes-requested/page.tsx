            ...
            <div className="max-w-lg w-full">
                ...
                <div className="bg-white rounded-b-[2rem] shadow-2xl overflow-hidden">
                    <div className="p-12 text-center">
                        ...
                        <h2 className="text-3xl font-black text-gray-900 mb-4">Feedback Sent!</h2>
                        <p className="text-gray-600 mb-8 text-base leading-relaxed">
                            Your request for changes has been sent to the <span className="font-bold text-gray-800">Help2Home admin team</span> and your <span className="font-bold text-gray-800">caretaker</span>.
                            The property listing publication process is now paused, and updates will be made based on your feedback.
                        </p>

                        <div className="text-left mb-10 max-w-md mx-auto">
                            <p className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-2 text-center sm:text-left">Regarding Property</p>
