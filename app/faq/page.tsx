    ...
    return (
        <main className="min-h-screen bg-white">
            ...
            <section className="bg-gray-900 text-white pt-24 pb-20 relative overflow-hidden">
                {/* Decorative circles */}
                <div className="absolute top-0 left-0 w-64 h-64 bg-brand-green/10 rounded-full blur-3xl -tranbrand-green-x-1/2 -tranbrand-green-y-1/2"></div>
                <div className="absolute bottom-0 right-0 w-96 h-96 bg-brand-purple/10 rounded-full blur-3xl tranbrand-green-x-1/3 tranbrand-green-y-1/3"></div>
