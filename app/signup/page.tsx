...
export const metadata: Metadata = {
    title: 'Sign Up - Help2Home',
    description: 'Join Help2Home as a Tenant, Landlord, or Investor.',
};
            ...
            <div className="container mx-auto px-6 md:px-12">
                <FadeIn>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                        <SignUpRoleCard
                            title="I'm a Tenant"
                            description="Find verified homes, pay rent monthly, and enjoy a stress-free renting experience."
                            href="/signup/tenant"
                        ...
                        <SignUpRoleCard
                            ...
                            description="List your properties, verify tenants, and receive rent payments upfront."
                        ...
                        <SignUpRoleCard
                            ...
                            description="Fund rental deals and earn attractive returns on your investment."
