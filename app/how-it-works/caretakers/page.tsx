...
import CaretakerSteps from '@/components/CaretakerSteps';
import CaretakerEarningsCalculator from '@/components/CaretakerEarningsCalculator';
import HowItWorksFAQs from '@/components/HowItWorksFAQs';

export const metadata: Metadata = {
    title: 'How It Works for Caretakers - Help2Home',
    description: 'Learn how to register as a caretaker, manage properties, and earn income with Help2Home.',
};

export default function CaretakerHowItWorksPage() {
    return (
        <main className="min-h-screen bg-white">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                            <div>
                                <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 leading-tight">
                                    How Help2Home Works for <span className="text-brand-green">Caretakers</span>
                                </h1>
                                <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                                    Register as a caretaker, manage multiple properties, and earn steady income while providing essential property services.
                                </p>
                                <div className="flex flex-col sm:flex-row gap-4">
                                    <Link
                                        href="/caretaker-signup"
                            ...
                            <div className="relative aspect-square md:aspect-[4/3] bg-gray-100 rounded-2xl flex items-center justify-center overflow-hidden">
                                ...
                                <div className="absolute inset-0 bg-gradient-to-br from-brand-green/5 to-brand-purple/5 flex items-center justify-center">
                                    <span className="text-gray-400 font-medium">Caretaker Journey Illustration</span>
                                </div>
                            </div>
                        </div>
                    </FadeIn>
            ...
            {/* Calculator Section */}
            <CaretakerEarningsCalculator />

            {/* CTA Section */}
            <section className="py-20 bg-gradient-to-br from-brand-green/5 to-brand-purple/5">
                <div className="container mx-auto px-6 md:px-12 text-center">
                    <FadeIn>
                        <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-8">Ready to Start Earning as a Caretaker?</h2>
