...
import { FiEye, FiEyeOff, FiLock, FiMail, FiArrowRight, FiUser, FiUsers } from 'react-icons/fi';
...
// Mapping buttons to your MOCK_USERS database
const DEMO_ACCOUNTS = [
                    ...
                    <form onSubmit={handleSubmit((data) => signIn(data.email, data.password))} className="space-y-5">
                        <div>
                            ...
                            <div className="relative group">
                                ...
                                <input 
                                    {...register('email')} 
                                    className={`w-full pl-12 pr-4 py-4 bg-slate-50 border-2 rounded-2xl outline-none transition-all ${errors.email ? 'border-red-500' : 'border-transparent focus:bg-white focus:border-brand-green'}`} 
                        ...
                        <div>
                            ...
                            <div className="relative group">
                                ...
                                <input 
                                    ...
                                    className={`w-full pl-12 pr-12 py-4 bg-slate-50 border-2 rounded-2xl outline-none transition-all ${errors.password ? 'border-red-500' : 'border-transparent focus:bg-white focus:border-brand-green'}`} 
                                    placeholder="••••••••" 
                                />
                                <button 
                                    type="button" 
                        ...
                        <motion.button 
                            ...
                            whileTap={{ scale: 0.98 }}
                            disabled={isLoading} 
                            className="w-full py-4 bg-brand-green hover:bg-green-600 text-white font-bold rounded-2xl shadow-lg shadow-brand-green/20 flex items-center justify-center gap-2 transition-all disabled:opacity-50"
                        >
