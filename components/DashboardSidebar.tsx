...
export default function DashboardSidebar({ isOpen = false, onClose }: DashboardSidebarProps) {
    ...
    const getUserRole = () => {
        ...
        if (pathname.startsWith('/dashboard/caretaker')) return 'caretaker';
    ...
    const tenantNavItems = [
        ...
        {
            label: 'Contract',
            href: '/dashboard/tenant/contracts', // Fixed href
            icon: (
                <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        {
            label: 'Education Hub',
            href: '/dashboard/tenant/education',
            icon: (
                <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    const caretakerNavItems = [
        ...
        {
            label: 'My Tasks',
            href: '/dashboard/caretaker', // Using dashboard as tasks hub for now
            icon: (
                <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    return (
        <aside className={`w-56 bg-[#00853E] text-white h-screen flex flex-col fixed left-0 top-0 z-40 rounded-tr-[30px] rounded-tl-[30px] transition-transform duration-300 ease-in-out md:translate-x-0 ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}>
            {/* Logo Area */}
            ...
            {/* Navigation */}
            <nav className="flex-1 px-6 space-y-4 overflow-y-auto pb-4">
                {navItems.map((item) => {
            ...
            {/* Logout */}
            <div className="p-6 mt-auto mb-4 flex-shrink-0">
                <button
                    onClick={logout}
                    className="flex items-center gap-4 px-4 py-3 w-full text-white/90 hover:text-white hover:bg-white/10 rounded-xl transition-colors font-medium"
                >
                    <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
