    ...
    return (
        <aside className="w-56 bg-[#00853E] text-white min-h-screen flex flex-col fixed left-0 top-0 z-40 rounded-tr-[30px] rounded-tl-[30px]">
            ...
            <div className="p-6 mt-auto mb-4">
                <button className="flex items-center gap-4 px-4 py-3 w-full text-white/90 hover:text-white hover:bg-white/10 rounded-xl transition-colors font-medium">
                    <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
