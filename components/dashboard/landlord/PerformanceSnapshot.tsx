...
export default function PerformanceSnapshot() {
    return (
        <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6 mb-6">
            ...
            <div className="space-y-6">
                ...
                <div>
                    ...
                    <div className="w-full bg-gray-100 rounded-full h-2">
                        <div className="bg-[#00853E] h-2 rounded-full" style={{ width: '85%' }}></div>
                    </div>
                ...
                <div>
                    ...
                    <div className="h-8 flex items-end gap-1">
                        ...
                        <div className="w-1/6 bg-[#00853E] h-4 rounded-t"></div>
                    </div>
                </div>
            ...
            <Link href="/dashboard/landlord/reports" className="w-full mt-4 text-sm text-[#00853E] font-medium hover:underline text-center block">
                View full report
            </Link>
        </div>
    );
