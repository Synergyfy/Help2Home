        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 relative overflow-hidden group">
                <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-24 w-24 text-[#00853E]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div className="relative z-10">
                    ...
                    <h3 className="text-3xl font-bold text-gray-900">₦1,250,000</h3>
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 relative overflow-hidden group">
                ...
                <div className="relative z-10">
                    ...
                    <h3 className="text-3xl font-bold text-gray-900">₦800,000</h3>
