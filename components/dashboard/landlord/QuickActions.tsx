    ...
    return (
        <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6 mb-6">
            ...
            <div className="space-y-3">
                <button onClick={handleNavigate} className="w-full bg-brand-green text-white py-3 px-4 rounded-xl font-bold hover:bg-green-700 transition-colors flex items-center justify-center gap-2">
