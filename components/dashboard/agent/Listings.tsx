            ...
            <div className="flex flex-col md:flex-row justify-between gap-4">
                ...
                <div className="flex gap-2">
                    <div className="relative flex-1 md:w-64">
                        ...
                        <input className="w-full pl-10 pr-4 py-2 bg-white border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-[#00853E]" placeholder="Search properties..." />
                    </div>
                    ...
                    <div key={prop.id} className="bg-white rounded-2xl border border-gray-100 overflow-hidden shadow-sm group">
                        ...
                        <div className="p-4">
                            ...
                            <div className="flex items-center gap-1 text-gray-500 text-xs mt-1">
                                <MdLocationOn size={14} className="text-[#00853E]" /> {prop.loc}
                            </div>
                            <div className="mt-4 flex justify-between items-center pt-4 border-t border-gray-50">
                                <span className="text-lg font-bold text-[#00853E]">{prop.price}</span>
