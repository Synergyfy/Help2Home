                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
                    ...
                    >
                        ...
                        <div className="p-8 bg-blue-600 relative shrink-0">
                            ...
                            <div className="flex items-center gap-6">
                                <div className="size-20 rounded-3xl bg-white/20 backdrop-blur-md flex flex-col items-center justify-center border border-white/30 text-white shadow-inner">
                                    <span className="text-[10px] font-black uppercase tracking-widest leading-none mb-1">{inspection.month}</span>
                                    <span className="text-3xl font-black leading-none">{inspection.day}</span>
                                </div>
                                <div>
                                    <h2 className="text-2xl font-black text-white leading-tight">Inspection Details</h2>
                        ...
                        <div className="p-8 space-y-8 overflow-y-auto custom-scrollbar">
                            {/* Client Info */}
                            <section>
                                <h3 className="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] mb-4 text-center">Client Information</h3>
                                <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-2xl border border-gray-100">
                                    <div className="size-12 rounded-full bg-blue-100 flex items-center justify-center text-blue-600">
                                        <HiOutlineUser size={24} />
                                    </div>
                                    <div className="flex-1">
                                        <p className="font-bold text-gray-900">{inspection.name}</p>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="p-5 rounded-3xl bg-gray-50 border border-gray-100">
                                    ...
                                    <p className="text-sm font-bold text-gray-900 leading-tight">{inspection.prop}</p>
                                </div>
                                <div className="p-5 rounded-3xl bg-gray-50 border border-gray-100">
                                    <HiOutlineClock className="text-blue-600 mb-3" size={24} />
                                    <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1">Time Slot</p>
                                    <p className="text-sm font-bold text-gray-900 leading-tight">{inspection.time}</p>
                                </div>
                            </div>
                            ...
                            <section>
                                <div className="p-5 rounded-3xl bg-gray-50 border border-gray-100 flex items-start gap-4">
                                    ...
                                    <div>
                                        <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1">Meeting Point</p>
                                        <p className="text-sm font-bold text-gray-900 leading-relaxed">
                                            {inspection.location || '123 Admiralty Way, Lekki Phase 1, Lagos'}
                                        </p>
                                        <button className="text-xs font-black text-brand-green mt-2 hover:underline">Get Directions →</button>
                                    </div>
                                </div>
                            </section>
                        </div>
