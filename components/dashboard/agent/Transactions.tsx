    ...
    return (
        <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
                <div className="p-4 border-b border-gray-50 font-bold text-sm text-gray-900">Recent Payouts</div>
                <div className="p-0">
                    {[1, 2, 3].map((_, i) => (
                        <div key={i} className="p-4 flex items-center justify-between border-b last:border-0 border-gray-50">
                            ...
                            <span className="text-sm font-bold text-gray-900">₦1,200,000</span>
                        </div>
                    ))}
                </div>
            </div>
