...
export function TicketSidebar({ ticket }: { ticket: any }) {
  return (
    <div className="w-80 bg-slate-50/30 overflow-y-auto hidden lg:block">
      {/* Action Area */}
      ...
      <div className="p-6 border-b border-slate-100 space-y-6">
        <div>
          ...
          <select className="w-full bg-white border border-slate-200 rounded-lg py-2 px-3 text-sm font-bold text-slate-700 focus:ring-2 focus:ring-emerald-500/20 outline-none">
      ...
      {/* Meta Details */}
      <div className="p-6 border-b border-slate-100">
        <h4 className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-4">Unit Information</h4>
