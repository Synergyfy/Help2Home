                ...
                <FadeIn direction="up" delay={0.2}>
                    <div className="bg-white rounded-3xl p-8 md:p-12 relative flex flex-col md:flex-row items-center gap-8 md:gap-12 shadow-sm max-w-4xl mx-auto mb-20 min-h-[300px]">
                        ...
                        <button
                            ...
                            className="absolute left-0 md:-left-6 top-1/2 -tranbrand-green-y-1/2 w-10 h-10 bg-white rounded-full shadow-md flex items-center justify-center text-brand-green hover:bg-gray-50 transition-colors z-10 border border-gray-100"
                        ...
                        <button
                            ...
                            className="absolute right-0 md:-right-6 top-1/2 -tranbrand-green-y-1/2 w-10 h-10 bg-white rounded-full shadow-md flex items-center justify-center text-brand-green hover:bg-gray-50 transition-colors z-10 border border-gray-100"
