...
export const MOCK_VERIFICATION: VerificationItem[] = [
    ...
    { id: 'license', label: 'Agency license', status: 'missing' }, // Example for agent
];

export interface Property {
    id: string;
    title: string;
    type: 'Apartment' | 'Room' | 'Studio' | 'Townhouse' | 'Detached House' | 'Commercial';
    ...
    status: 'Published' | 'Draft' | 'Paused' | 'Under Review';
    specs: {
        bedrooms: number;
        bathrooms: number;
        area: number;
        areaUnit: 'sqft' | 'sqm';
        furnishing: 'Furnished' | 'Partly Furnished' | 'Unfurnished';
    };
    amenities: string[];
    images: {
        id: string;
    ...
    installments?: {
        ...
        tenures?: number[]; // months, e.g., [6, 12]
    };
    metrics: {
        views: number;
        applications: number;
...
export const mockProperties: Property[] = [
    {
        ...
        amenities: ['24/7 Power', 'Security', 'Pool', 'Gym', 'WiFi'],
        images: [
            { id: 'img1', url: '/assets/apartment-1.jpg', isPrimary: true },
        ],
        installments: {
            enabled: true,
            depositPercent: 25,
    ...
    },
    {
        ...
        listingType: 'Rent',
        address: {
            street: '45 Herbert Macaulay Way',
            city: 'Yaba',
            state: 'Lagos',
        },
        price: {
        ...
        images: [
            { id: 'img2', url: '/assets/studio-1.jpg', isPrimary: true },
        ],
        installments: {
            enabled: false,
        },
        metrics: {
            views: 0,
            applications: 0,
            lastUpdated: '2024-05-20T14:15:00Z',
        },
    },
    {
        id: 'prop-3',
        ...
        amenities: ['Pool', 'Garden', 'Cinema', 'Smart Home', 'BQ'],
        images: [
            { id: 'img3', url: '/assets/house-1.jpg', isPrimary: true },
        ],
        installments: {
            enabled: true,
            depositPercent: 50,
