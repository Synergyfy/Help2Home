        ...
        <header className="h-20 bg-white border-b border-gray-100 flex items-center justify-between px-8 sticky top-0 z-40">
            <div className="flex-1 max-w-md">
                {!isTenantMode ? (
                    ...
                    <div className="flex items-center gap-2 text-gray-400 px-4 py-2 bg-gray-50 rounded-xl border border-dashed border-gray-200">
                        <HiOutlineShieldCheck size={18} />
                        <span className="text-xs font-bold uppercase tracking-widest">Secure Verification Session</span>
                    </div>
                )}
            </div>
                    ...
                    >
                        <div className="text-right hidden sm:block">
                            <p className="text-sm font-semibold text-gray-900 leading-tight">
                                {isTenantMode ? 'Guest Tenant' : 'Access Bank PLC'}
                            </p>
                            <p className="text-[10px] text-gray-500 font-medium">
                                {isTenantMode ? 'Session Active' : 'Head Office - Lagos'}
                            </p>
                        </div>
                        ...
                        {isDropdownOpen && (
                            ...
                            >
                                <div className="p-4 bg-gray-50/50 border-b border-gray-100">
                                    ...
                                    <p className="text-sm font-semibold text-gray-900">{isTenantMode ? 'Guest Tenant' : 'John Bank Manager'}</p>
                                    {!isTenantMode && <p className="text-xs text-gray-500">manager@accessbank.com</p>}
                                </div>
                                ...
                                <div className="p-2 bg-gray-50/50">
                                    ...
                                    >
                                        ...
                                        {isTenantMode ? 'Exit Verification' : 'Logout'}
                                    </button>
                                </div>
                            </motion.div>
                        )}
