                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
                    ...
                    >
                        <div className="p-8">
                            ...
                            <h2 className="text-2xl font-semibold text-gray-900 mb-2">Reschedule Viewing</h2>
                            <p className="text-gray-500 font-medium leading-relaxed mb-8">
                                Change the date and time for <span className="text-gray-900 font-semibold">{appointment.client}'s</span> inspection of <span className="text-gray-900 font-semibold">{appointment.property || appointment.prop}</span>.
                            </p>

                            <form onSubmit={handleSubmit} className="space-y-6">
                                <div>
                                    <label className="block text-[10px] font-semibold text-gray-400 uppercase tracking-widest mb-2 px-1">New Date</label>
                                ...
                                <div>
                                    <label className="block text-[10px] font-semibold text-gray-400 uppercase tracking-widest mb-2 px-1">New Time Slot</label>
                                    <div className="relative">
