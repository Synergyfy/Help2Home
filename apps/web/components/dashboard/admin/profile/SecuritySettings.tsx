  ...
  return (
    <div className="bg-white rounded-2xl border border-brand-green-100 shadow-sm overflow-hidden">
      <div className="p-6 border-b border-brand-green-50 bg-white">
        <h3 className="text-lg font-black text-brand-green-900 tracking-tight">Security Settings</h3>
        <p className="text-sm text-brand-green-500 font-medium">Manage your password and account protection.</p>
      </div>
        ...
        <div className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              <label className="text-[10px] font-black text-brand-green-500 uppercase tracking-widest px-1">New Password</label>
              <input 
                type="password" 
                placeholder="••••••••" 
                className="w-full bg-brand-green-50 border-none rounded-xl px-4 py-3 text-sm font-bold text-brand-green-900 focus:ring-2 focus:ring-brand-green/20 outline-none transition-all" 
              />
            </div>
            <div className="space-y-2">
              <label className="text-[10px] font-black text-brand-green-500 uppercase tracking-widest px-1">Confirm Password</label>
              <input 
                type="password" 
                placeholder="••••••••" 
                className="w-full bg-brand-green-50 border-none rounded-xl px-4 py-3 text-sm font-bold text-brand-green-900 focus:ring-2 focus:ring-brand-green/20 outline-none transition-all" 
          ...
          <div className="flex justify-end pt-2">
            <button className="flex items-center gap-2 border border-brand-green-200 px-6 py-3 rounded-xl font-bold text-sm text-brand-green-700 hover:bg-brand-green-50 transition-all shadow-sm">
