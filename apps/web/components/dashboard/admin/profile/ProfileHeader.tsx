...
export function ProfileHeader({ profile }: { profile: any }) {
  ...
  return (
    <div className="bg-white rounded-2xl border border-brand-green-100 p-8 flex flex-col items-center text-center shadow-sm">
      ...
      <p className="text-sm font-bold text-brand-green-500 mb-4">Super Admin</p>
      ...
      <div className="w-full mt-8 border-t border-brand-green-50 pt-6 space-y-4">
        <div className="flex justify-between items-center text-sm">
          ...
          <span className="font-bold text-brand-green-900">Aug 20, 2021</span>
        </div>
        <div className="flex justify-between items-center text-sm">
          <span className="text-brand-green-500 font-semibold uppercase text-[10px] tracking-widest">Last Login</span>
          <span className="font-bold text-brand-green-900">Today, 09:41 AM</span>
        </div>
      </div>
    </div>
  );
