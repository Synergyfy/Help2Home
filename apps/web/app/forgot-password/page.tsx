                ...
                <div className="w-full max-w-[440px]">
                    ...
                    {!isSent ? (
                        <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                            <h1 className="text-3xl font-bold text-brand-green-900 mb-3">Reset Password</h1>
                            <p className="text-brand-green-500 mb-10 text-lg">
                            ...
                            >
                                <div className="space-y-2">
                                    <label className="block text-sm font-bold text-brand-green-700 uppercase tracking-wider">
                                        Email Address
                                    </label>
                                    <div className="relative group">
                                        ...
                                        <input 
                                            required 
                                            type="email" 
                                            className="w-full pl-12 pr-4 py-4 bg-brand-green-50 border-2 border-brand-green-100 rounded-2xl focus:bg-white focus:border-brand-green outline-none transition-all" 
                        ...
                        <div className="text-center animate-in fade-in zoom-in-95 duration-400">
                            ...
                            <h1 className="text-2xl font-bold text-brand-green-900 mb-2">Check your email</h1>
                            <p className="text-brand-green-500 mb-8 leading-relaxed">
