...
import { MdAdd, MdArrowForward, MdConstruction } from 'react-icons/md';
...
export default function DeveloperDashboardPage() {
    ...
    return (
        <ComingSoonBlur 
            ...
            description="We're building the most transparent property development toolkit in the region. Real-time funding, project reporting, and investor management tools are on the way."
        >
